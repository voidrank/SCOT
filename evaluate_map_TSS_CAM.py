...
def run(datapath, benchmark, backbone, thres, alpha, hyperpixel,
    ...
    if not os.path.isdir('logs'):
        os.mkdir('logs')
    logfile = 'logs/{}_{}_{}_{}_exp{}-{}_e{}_m{}_{}_{}'.format(benchmark, backbone, args.split, args.sim, args.exp1,
                                                               args.exp2, args.eps, args.classmap, args.cam,
                                                               args.hyperpixel)
    print(logfile)
    ...
    for idx, data in enumerate(dataloader):
        ...
        with torch.no_grad():
            ...
            confidence_ts, trg_box, src_box = model(trg_img, src_img, args.sim, args.exp1, args.exp2, args.eps,
                                                    args.classmap, trg_bbox, src_bbox, trg_mask, src_mask, backbone)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cam', type=str, default='',
                        help='extract activation map end2end rather than pre-calculation')
